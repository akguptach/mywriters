                                ...
                                <div id="u_column_2" class="u-col u-col-100"
                                    ...
                                    <div
                                        ...
                                        <div class="v-col-border"
                                            style="box-sizing: border-box; height: 100%; padding: 0px;border-top: 15px solid #8d95ff;border-left: 15px solid #8d95ff;border-right: 15px solid #8d95ff;border-bottom: 15px solid #8d95ff;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
                                            <!--<![endif]-->
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="overflow-wrap:break-word;word-break:break-word;padding:30px 10px 20px;font-family:'Raleway',sans-serif;"
                                                            align="left">
                                                                ...
                                                                <tr>
                                                                    <td style="padding-right: 0px;padding-left: 0px;"
                                                                        ...
                                                                        <img align="center" border="0"
                                                                            src="{{ asset('email/images/logo.png') }}"
                                                                            alt="{{ env('APP_NAME') }} Logo"
                                                                            title="{{ env('APP_NAME') }} Logo"
                                                                            style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 16%;max-width: 300px;"
                                                                            width="300"
                                            ...
                                            <table style="font-family:'Raleway',sans-serif;" role="presentation"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="overflow-wrap:break-word;word-break:break-word;padding:10px 0px;font-family:'Raleway',sans-serif;"
                                                            align="left">
                                            ...
                                            <table id="u_content_text_2" style="font-family:'Raleway',sans-serif;"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="overflow-wrap:break-word;word-break:break-word;padding:20px 40px 10px;font-family:'Raleway',sans-serif;"
                                                            align="left">
                                            ...
                                            <table id="u_content_text_1" style="font-family:'Raleway',sans-serif;"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="overflow-wrap:break-word;word-break:break-word;padding:20px 40px 30px;font-family:'Raleway',sans-serif;"
                                                            align="left">
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="line-height: 140%;"><span
                                                                        data-metadata="&lt;!--(figmeta)eyJmaWxlS2V5IjoiTHJJMHBSU20xM203UWc0Tk1XZXVQeCIsInBhc3RlSUQiOjE4NjYyMDI5OTgsImRhdGFUeXBlIjoic2NlbmUifQo=(/figmeta)--&gt;"
                                                                        style="line-height: 19.6px;"></span>Please do
                                                                    not share the verification code with anyone. </p>
                                                                <p style="line-height: 140%;"><br /><em><strong>Thank
                                                                            You</strong></em></p>
                                                                <p style="line-height: 140%;">
                                                                    <em><strong>{{ env("APP_NAME") }}</strong></em></p>
                                                            </div>
                        ...
                        <div class="u-row"
                            ...
                            <div
                                ...
                                <div class="u-col u-col-100"
                                    style="max-width: 320px;min-width: 600px;display: table-cell;vertical-align: top;">
                                    <div
                                        style="background-color: #8d95ff;height: 100%;width: 100% !important;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
                                        <!--[if (!mso)&(!IE)]><!-->
                                        <div class="v-col-border"
                                                                            ...
                                                                            <tr style="vertical-align: top">
                                                                                <td align="left" valign="middle"
                                                                                    ...
                                                                                    <a href="https://www.linkedin.com"
                                                                                        title="LinkedIn"
                                                                                        target="_blank">
                                                                                        <img src="{{ asset('email/images/image-6.png') }}"
                                                                                            alt="LinkedIn"
                                            ...
                                            <table id="u_content_image_3" style="font-family:'Raleway',sans-serif;"
                                                role="presentation" cellpadding="0" cellspacing="0" width="100%"
                                                border="0">
                                                <tbody>
                                                    <tr>
