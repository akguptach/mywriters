    ...
    <div class="col-md-8">
        <div class="card1">
            ...
            <div class="card card-primary card-outline direct-chat direct-chat-primary">
                        ...
                        <div class="input-group">
                            ...
                            <span class="input-group-append">
                                <a class="btn btn-info btn-sm" href="javascript::void(0);"
                                    onclick="document.getElementById('attachment').click()" value="Select a File"
                ...
                <div class="card-footer">
                    <form method="POST" action="{{route('submit_final',['id'=>$orderRequest->id])}}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" id="inputEstimatedBudget" class="form-control" name="attachment"
                                style="    height: 100%;">
                            @error('attachment')
