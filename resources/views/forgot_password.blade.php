                      ...
                      <div class="card-body">
                        ...
                        <form role="form text-left" id="login_form" method="POST" action="{{route('tutor_forgot_password')}}">
                          ...
                          <div class="text-center">
                            <button type="submit" class="btn bg-gradient-dark w-100 my-4 mb-2">Forgot password</button>
                          </div>
                          <small class="text-muted">Login
                            <a href="{{route('home')}}" class="text-info text-gradient font-weight-bold">here</a>
                          </small>
